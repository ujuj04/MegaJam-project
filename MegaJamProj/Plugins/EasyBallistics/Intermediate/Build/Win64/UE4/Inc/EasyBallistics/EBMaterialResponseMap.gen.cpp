...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_EasyBallistics_EPenTraceType_Hash() { return 3530446347U; }
	UEnum* Z_Construct_UEnum_EasyBallistics_EPenTraceType()
	{
		...
		if (!ReturnEnum)
		{
			static const UE4CodeGen_Private::FEnumeratorParam Enumerators[] = {
				{ "EPenTraceType::PT_Back", (int64)EPenTraceType::PT_Back },
				{ "EPenTraceType::PT_Solid", (int64)EPenTraceType::PT_Solid },
				{ "EPenTraceType::PT_Forward", (int64)EPenTraceType::PT_Forward },
			};
#if WITH_METADATA
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				{ "BlueprintType", "true" },
				{ "ModuleRelativePath", "Public/EBMaterialResponseMap.h" },
				{ "PT_Back.DisplayName", "Back Trace" },
				{ "PT_Back.Name", "EPenTraceType::PT_Back" },
				{ "PT_Forward.DisplayName", "Forward Trace" },
				{ "PT_Forward.Name", "EPenTraceType::PT_Forward" },
				{ "PT_Solid.DisplayName", "Solid" },
				{ "PT_Solid.Name", "EPenTraceType::PT_Solid" },
			};
#endif
...
static struct FScriptStruct_EasyBallistics_StaticRegisterNativesFEBMaterialResponseMapEntry
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FEBMaterialResponseMapEntry_Hash() { return 3665201457U; }
	...
	IMPLEMENT_CLASS(UEBMaterialResponseMap, 1610191699);
