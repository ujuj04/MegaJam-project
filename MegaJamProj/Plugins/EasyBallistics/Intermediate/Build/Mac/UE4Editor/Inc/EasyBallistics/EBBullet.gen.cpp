...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_EasyBallistics_EEBAtmosphereType_Hash() { return 1272552758U; }
	...
	bool AEBBullet::CollisionFilter(FHitResult HitResult)
	{
		EBBullet_eventCollisionFilter_Parms Parms;
		Parms.HitResult=HitResult;
		ProcessEvent(FindFunctionChecked(NAME_AEBBullet_CollisionFilter),&Parms);
	...
	float AEBBullet::GetAirDensity(UWorld* World, FVector Location)
	{
		EBBullet_eventGetAirDensity_Parms Parms;
		Parms.World=World;
		Parms.Location=Location;
		ProcessEvent(FindFunctionChecked(NAME_AEBBullet_GetAirDensity),&Parms);
		return Parms.ReturnValue;
	}
	static FName NAME_AEBBullet_GetSpeedOfSound = FName(TEXT("GetSpeedOfSound"));
	float AEBBullet::GetSpeedOfSound(UWorld* World, FVector Location)
	{
		EBBullet_eventGetSpeedOfSound_Parms Parms;
		Parms.World=World;
		Parms.Location=Location;
		ProcessEvent(FindFunctionChecked(NAME_AEBBullet_GetSpeedOfSound),&Parms);
		return Parms.ReturnValue;
	}
	static FName NAME_AEBBullet_GetWind = FName(TEXT("GetWind"));
	FVector AEBBullet::GetWind(UWorld* World, FVector Location)
	{
		EBBullet_eventGetWind_Parms Parms;
		Parms.World=World;
		Parms.Location=Location;
		ProcessEvent(FindFunctionChecked(NAME_AEBBullet_GetWind),&Parms);
		return Parms.ReturnValue;
	}
	...
	FVector AEBBullet::UpdateVelocity(UWorld* World, FVector Location, FVector PreviousVelocity, float DeltaTime)
	{
		...
		ProcessEvent(FindFunctionChecked(NAME_AEBBullet_UpdateVelocity),&Parms);
		return Parms.ReturnValue;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AEBBullet_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AEBBullet_CollisionFilter, "CollisionFilter" }, // 3491174086
		...
		{ &Z_Construct_UFunction_AEBBullet_GetAirDensity, "GetAirDensity" }, // 2899382603
		{ &Z_Construct_UFunction_AEBBullet_GetSpeedOfSound, "GetSpeedOfSound" }, // 3942359305
		{ &Z_Construct_UFunction_AEBBullet_GetWind, "GetWind" }, // 967822275
		{ &Z_Construct_UFunction_AEBBullet_OnImpact, "OnImpact" }, // 3332238923
		{ &Z_Construct_UFunction_AEBBullet_OnTrace, "OnTrace" }, // 949135130
		{ &Z_Construct_UFunction_AEBBullet_OnTrajectoryUpdateReceived, "OnTrajectoryUpdateReceived" }, // 3016676656
		{ &Z_Construct_UFunction_AEBBullet_ReactivationBroadcast, "ReactivationBroadcast" }, // 4106498884
		{ &Z_Construct_UFunction_AEBBullet_Spawn, "Spawn" }, // 4148675329
		{ &Z_Construct_UFunction_AEBBullet_SpawnWithExactVelocity, "SpawnWithExactVelocity" }, // 2724629350
		{ &Z_Construct_UFunction_AEBBullet_UpdateVelocity, "UpdateVelocity" }, // 254848843
		{ &Z_Construct_UFunction_AEBBullet_VelocityChangeBroadcast, "VelocityChangeBroadcast" }, // 603537373
		{ &Z_Construct_UFunction_AEBBullet_VelocityChangeBroadcastReliable, "VelocityChangeBroadcastReliable" }, // 2624064520
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AEBBullet, 3644742428);
