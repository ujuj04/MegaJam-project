...
FVector AEBBullet::GetWind_Implementation(UWorld* World, FVector Location) {
	return Wind;
}

float AEBBullet::GetAirDensity_Implementation(UWorld* World, FVector Location) {
...
float AEBBullet::GetSpeedOfSound_Implementation(UWorld* World, FVector Location) {
