...
{
	PT_Back UMETA(DisplayName = "Back Trace"),
	PT_Solid UMETA(DisplayName = "Solid"),
	PT_Forward UMETA(DisplayName = "Forward Trace"),
};
...
struct FEBMaterialResponseMapEntry {
	...
	UPROPERTY(EditAnywhere, Category = "Material") EPenTraceType PenTraceType = EPenTraceType::PT_Back;
